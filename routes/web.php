...
Route::group(['prefix' => 'admin'], function() {
    ...
    //crud siswa
    Route::post('/siswa', 'AdminSiswaController@store')->name('admin.siswa.store');
    Route::get('/siswa/{nis}/edit', 'AdminSiswaController@edit')->name('admin.siswa.edit');
    Route::put('/siswa/{nis}', 'AdminSiswaController@update')->name('admin.siswa.update');
    Route::delete('/siswa/{nis}', 'AdminSiswaController@destroy')->name('admin.siswa.destroy');
});
